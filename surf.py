...
'''
SURF features detection & extraction + BruteForce Matching + RANSAC homography 

A simple example of feature extraction techniques using SURF features,
...
Usage:
------
    surf.py <img1> <img2> --h <HessianMx value> --nO <NumberOfOctaves value> --nL <NumberOfLayers value> --e <128 descriptor length> --u <U-SURF> --kpfixed <fixed colour features> --v <print images>  --o <output data files>"

    h: HessianMx blob size
    nO: Number of Octaves
    nL: Number of Octave Layers
    u: Set Upright (U-SURF) on/off
    e: Set 64 or 128 mode
...
if __name__ == '__main__':
	...
	try:
		...
		opts, args = getopt.getopt(sys.argv[3:], '', ['h=' , 'nO=' , 'nL=' , 'e' , 'u', 'kpfixed', 'v', 'o' ])
	except getopt.GetoptError as e:
		print (str(e))
		print "Usage: <img1> <img2> --h <HessianMx value> --nO <NumberOfOctaves value> --nL <NumberOfLayers value> --e <128 descriptor length> --u <U-SURF> --kpfixed <fixed colour features> --v <print images>  --o <output data files>"
		sys.exit(2)
	

	for o, a in opts:	
		
		if o == '--h':				# hessian matrix levels
			hessianThreshold = a
		elif o == '--nO':			# number of octaves
			nOctaves = a
		elif o == '--nL':			# number of octave Layers
			nOctaveLayers = a
		elif o == '--u':			# upright on/off
			upright = 1
		elif o == '--e':			# extended mode
			extended = 1
			...
			"Usage: <img1> <img2> --h <HessianMx value> --nO <NumberOfOctaves value> --nL <NumberOfLayers value> --e <128 descriptor length> --u <U-SURF> --kpfixed <fixed colour features> --v <print images>  --o <output data files>"
	...
	print "\nHessianMx: %d, Octaves: %d, OctaveLayers: %d, Upright: %d, Extended: %d" % (hessianThreshold,nOctaves,nOctaveLayers,extended,upright)
	...
	#save_path = "%s/surf_logs/%s_%s/" % (timestampFolder, sys.argv[1][:25] , sys.argv[2][:25] )
	#print save_path
	#os.mkdir(save_path, 0775)	
	...
	mdata = {	
				'Query': queryImg, 'Descriptor' : 'SURF' , 'HessianMx': hessianThreshold ,
